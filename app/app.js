...
const subAdminReportRoutes=require("./routes/admin/report.routes")
...
const subAdminpercentageLimitRouters=require("./routes/subAdmin/percentageLimit.routes")
...
const corsOptions = {
  // origin: 'https://gwtech.vercel.app',
...
subAdminReportRoutes(app);
subAdminpercentageLimitRouters(app);  //18/10/2024
